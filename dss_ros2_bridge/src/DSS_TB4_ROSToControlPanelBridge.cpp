...
class DSS_TB4_ROSToControlPanelNode : public rclcpp::Node {
public:
...
public:
    DSS_TB4_ROSToControlPanelNode() : Node("DSS_TB4_ROSToControlPanelNode") {
        ...
        timer_   = this->create_wall_timer(std::chrono::seconds(3), std::bind(&DSS_TB4_ROSToControlPanelNode::onTick, this));
    ...
    ~DSS_TB4_ROSToControlPanelNode() override
    {
...
int main(int argc, char** argv)
{
    ...
    rclcpp::spin(std::make_shared<DSS_TB4_ROSToControlPanelNode>());
    rclcpp::shutdown();
}
